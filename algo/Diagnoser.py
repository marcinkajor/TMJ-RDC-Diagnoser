...
from algo.AlgoPalpation import createPalpations, combinePalpations, Palpations, Palpation
...
class Diagnoser:
    ...
    def loadPatient(self, pesel: str):
        ...
        e6 = E6()
        e6.addSound("left", "open", e6data["E6sounds"]["opening_left"])
        e6.addSound("left", "close", e6data["E6sounds"]["closing_left"])
        e6.addSound("right", "open", e6data["E6sounds"]["opening_right"])
        e6.addSound("right", "close", e6data["E6sounds"]["closing_right"])
        ...
        e7 = E7(e7data["E7mm"]["right"], ["E7mm"]["left"], e7data["E7mm"]["E7middleLine"])
